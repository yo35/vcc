...
Glib::ustring keyval_to_symbol(Keyval val) {
	...
	switch(val) {
		...
		case GDK_Cyrillic_io              : return "ё";
		case GDK_Cyrillic_yu              : return "ю";
		case GDK_Cyrillic_a               : return "а";
		case GDK_Cyrillic_be              : return "б";
		case GDK_Cyrillic_tse             : return "ц";
		case GDK_Cyrillic_de              : return "д";
		case GDK_Cyrillic_ie              : return "е";
		case GDK_Cyrillic_ef              : return "ф";
		case GDK_Cyrillic_ghe             : return "г";
		case GDK_Cyrillic_ha              : return "х";
		case GDK_Cyrillic_i               : return "и";
		case GDK_Cyrillic_shorti          : return "й";
		case GDK_Cyrillic_ka              : return "к";
		case GDK_Cyrillic_el              : return "л";
		case GDK_Cyrillic_em              : return "м";
		case GDK_Cyrillic_en              : return "н";
		case GDK_Cyrillic_o               : return "о";
		case GDK_Cyrillic_pe              : return "п";
		case GDK_Cyrillic_ya              : return "я";
		case GDK_Cyrillic_er              : return "р";
		case GDK_Cyrillic_es              : return "с";
		case GDK_Cyrillic_te              : return "т";
		case GDK_Cyrillic_u               : return "у";
		case GDK_Cyrillic_zhe             : return "ж";
		case GDK_Cyrillic_ve              : return "в";
		case GDK_Cyrillic_softsign        : return "ь";
		case GDK_Cyrillic_yeru            : return "ы";
		case GDK_Cyrillic_ze              : return "з";
		case GDK_Cyrillic_sha             : return "ш";
		case GDK_Cyrillic_e               : return "э";
		case GDK_Cyrillic_shcha           : return "щ";
		case GDK_Cyrillic_che             : return "ч";
		case GDK_Cyrillic_hardsign        : return "ъ";
		case GDK_Ukrainian_i              : return "і";
		case GDK_Ukrainian_ie             : return "є";
		case GDK_Ukrainian_yi             : return "ї";
		case GDK_Ukrainian_ghe_with_upturn: return "ґ";
